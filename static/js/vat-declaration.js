...
function renderSchedule1(data) {
  ...
  return '<div style="font-size:13px;font-weight:700;text-align:center;margin-bottom:4px">增值税及附加税费申报表附列资料（一）</div>'
    ...
    + '<col style="width:9%">'   // 项目名称
    + '<col style="width:4%">'   // 栏次
    ...
    + '<th colspan="2">扣除后</th></tr>'
    + '<tr style="background:#d9e2f3">'
    + '<th>销售额</th><th>销项(应纳)<br>税额</th><th>销售额</th><th>销项(应纳)<br>税额</th>'
    + '<th>销售额</th><th>销项(应纳)<br>税额</th><th>销售额</th><th>销项(应纳)<br>税额</th>'
    + '<th>销售额</th><th>销项(应纳)<br>税额</th><th>价税<br>合计</th>'
    + '<th>含税(免税)<br>销售额</th><th>销项(应纳)<br>税额</th></tr>'
    + '<tr style="background:#d9e2f3">'
...
function renderSchedule4(data) {
  ...
  return '<div style="font-size:13px;font-weight:700;text-align:center;margin-bottom:4px">增值税及附加税费申报表附列资料（四）</div>'
    ...
    + '<table class="vat-form-table" style="table-layout:fixed;width:100%"><colgroup><col style="width:5%"><col style="width:15%"><col style="width:13.34%"><col style="width:13.33%"><col style="width:13.33%"><col style="width:13.33%"><col style="width:13.34%"><col style="width:13.33%"></colgroup>'
