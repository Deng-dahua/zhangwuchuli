...
function renderSchedule1(data) {
  ...
  return '<div style="font-size:13px;font-weight:700;text-align:center;margin-bottom:4px">增值税及附加税费申报表附列资料（一）</div>'
    ...
    + '<table class="vat-form-table" style="font-size:10px;min-width:1600px;table-layout:fixed;width:100%">'
    + '<colgroup>'
    + '<col style="width:2.5%"><col style="width:3.5%"><col style="width:11.5%"><col style="width:2%">'
    + '<col style="width:5.75%"><col style="width:5.75%"><col style="width:5.75%"><col style="width:5.75%">'
    + '<col style="width:5.75%"><col style="width:5.75%"><col style="width:5.75%"><col style="width:5.75%">'
    + '<col style="width:5.75%"><col style="width:5.75%"><col style="width:5.75%"><col style="width:5.75%">'
    + '<col style="width:5.75%"><col style="width:5.75%"></colgroup>'
    + '<thead>'
    ...
    + '<th colspan="2">纳税检查<br>调整</th>'
    + '<th colspan="3">合计</th>'
    + '<th rowspan="2">服务、不动产和<br>无形资产扣除项目<br>本期实际扣除金额</th>'
    + '<th colspan="2">扣除后</th>'
    + '</tr>'
    + '<tr style="background:#d9e2f3">'
    + '<th>销售额</th><th>销项(应纳)<br>税额</th>'
    + '<th>销售额</th><th>销项(应纳)<br>税额</th>'
    + '<th>销售额</th><th>销项(应纳)<br>税额</th>'
    + '<th>销售额</th><th>销项(应纳)<br>税额</th>'
    + '<th>销售额</th><th>销项(应纳)<br>税额</th><th>价税<br>合计</th>'
    + '<th>含税(免税)<br>销售额</th><th>销项(应纳)<br>税额</th>'
    + '</tr>'
