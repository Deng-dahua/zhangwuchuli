...
function renderSchedule1(data) {
  ...
  return '<div style="font-size:13px;font-weight:700;text-align:center;margin-bottom:4px">增值税及附加税费申报表附列资料（一）</div>'
    ...
    + '<colgroup>'
    + '<col style="width:3.5%"><col style="width:5%"><col style="width:12%"><col style="width:3.5%">'
    + '<col style="width:5.35%"><col style="width:5.35%"><col style="width:5.35%"><col style="width:5.35%">'
    + '<col style="width:5.35%"><col style="width:5.35%"><col style="width:5.35%"><col style="width:5.35%">'
    + '<col style="width:5.35%"><col style="width:5.35%"><col style="width:5.35%"><col style="width:5.35%">'
    + '<col style="width:7%"><col style="width:4.8%"></colgroup>'
    + '<thead>'
