...
async function renderSalesInvoices(container) {
  ...
  try {
    ...
    html += '<button onclick="var e=document.getElementById(\'siDateFrom\');e.type=\'date\';e.value=siFilter.dateFrom||\'\';e.onchange=function(){e.type=\'text\';var v=this.value;e.value=v.replace(/-/g,\'/\');siFilter.dateFrom=v;e.onchange=function(){siFilter.dateFrom=this.value.replace(/\\//g,\'-\');renderSalesInvoices()};renderSalesInvoices()};e.showPicker()" style="padding:6px 7px;border:1px solid #d1d5db;border-left:none;border-radius:0 6px 6px 0;background:#fff;cursor:pointer;display:inline-flex;align-items:center;justify-content:center" title="选择日期"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="1.5" y="3.5" width="13" height="11" rx="1.5" stroke="#6b7280" stroke-width="1.2"/><path d="M1.5 6.5h13" stroke="#6b7280" stroke-width="1.2"/><path d="M4.5 1v3.5M11.5 1v3.5" stroke="#6b7280" stroke-width="1.2" stroke-linecap="round"/></svg></button>';
    html += '</span>';
    ...
    html += '<button onclick="var e=document.getElementById(\'siDateTo\');e.type=\'date\';e.value=siFilter.dateTo||\'\';e.onchange=function(){e.type=\'text\';var v=this.value;e.value=v.replace(/-/g,\'/\');siFilter.dateTo=v;e.onchange=function(){siFilter.dateTo=this.value.replace(/\\//g,\'-\');renderSalesInvoices()};renderSalesInvoices()};e.showPicker()" style="padding:6px 7px;border:1px solid #d1d5db;border-left:none;border-radius:0 6px 6px 0;background:#fff;cursor:pointer;display:inline-flex;align-items:center;justify-content:center" title="选择日期"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="1.5" y="3.5" width="13" height="11" rx="1.5" stroke="#6b7280" stroke-width="1.2"/><path d="M1.5 6.5h13" stroke="#6b7280" stroke-width="1.2"/><path d="M4.5 1v3.5M11.5 1v3.5" stroke="#6b7280" stroke-width="1.2" stroke-linecap="round"/></svg></button>';
    html += '</span>';
