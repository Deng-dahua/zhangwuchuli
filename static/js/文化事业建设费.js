...
const CCF_ROWS = [
  { key: 'row1_taxable_income',              label: '1',                    category: '计费收入',   calc: null },
  { key: 'row2_tax_exempt_income',           label: '2',                    category: '计费收入',   calc: null },
  { key: 'row3_deduction_beginning',         label: '3',                    category: '费额计算',   calc: null },
  { key: 'row4_deduction_current_period',    label: '4',                    category: '费额计算',   calc: null },
  { key: 'row5_taxable_income_deduction',    label: '5',                    category: '费额计算',   calc: null },
  { key: 'row6_tax_exempt_deduction',        label: '6',                    category: '费额计算',   calc: null },
  { key: 'row7_deduction_ending_balance',     label: '7=3+4-5-6',           category: '费额计算',   calc: '3+4-5-6' },
  { key: 'row8_taxable_sales',               label: '8=1-5',                category: '费额计算',   calc: '1-5' },
  { key: 'row9_fee_rate',                    label: '9',                    category: '费额计算',   calc: null },
  { key: 'row10_payable_fee',                label: '10=8×9',              category: '费额计算',   calc: '8×9' },
  { key: 'row11_unpaid_beginning',           label: '11',                   category: '费额缴纳',   calc: null },
  { key: 'row12_paid_current_period',         label: '12=13+14+15',         category: '费额缴纳',   calc: '13+14+15' },
  { key: 'row13_prepaid',                    label: '13',                   category: '费额缴纳',   calc: null },
  { key: 'row14_paid_last_period',           label: '14',                   category: '费额缴纳',   calc: null },
  { key: 'row15_paid_arrears',               label: '15',                   category: '费额缴纳',   calc: null },
  { key: 'row16_unpaid_ending',              label: '16=10+11-12',         category: '费额缴纳',   calc: '10+11-12' },
  { key: 'row17_arrears',                    label: '17=11-14-15',         category: '费额缴纳',   calc: '11-14-15' },
  { key: 'row18_fill_refund',                label: '18=10-13',            category: '费额缴纳',   calc: '10-13' },
  { key: 'row19_inspected_supplement',       label: '19',                   category: '费额缴纳',   calc: null },
];
