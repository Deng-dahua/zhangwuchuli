...
def _classify_purchase_debit(db, company_id, inv):
    ...
    CATEGORY_ACCOUNT_MAP = {
        ...
        "餐饮服务":     ("660216", "管理费用/业务招待费",     "损益", "借"),
        "住宿服务":     ("660202", "管理费用/差旅费",         "损益", "借"),
        "运输服务":     ("660206", "管理费用/交通费",         "损益", "借"),
        "经纪代理服务": ("660202", "管理费用/差旅费",         "损益", "借"),
        "旅游服务":     ("660216", "管理费用/业务招待费",     "损益", "借"),
        "生活服务":     ("660299", "管理费用/其他费用",       "损益", "借"),
        "保险服务":     ("660299", "管理费用/其他费用",       "损益", "借"),
        # === 资产类（非费用！后续消费/核销时再转费用） ===
        "预付卡销售":   ("1221",  "其他应收款",                "资产", "借"),
        # === 商品类 ===
        "照相器材":     ("1405",  "库存商品",                "资产", "借"),
        "纺织产品":     ("660299", "管理费用/其他费用",       "损益", "借"),
        "家用美容保健电器": ("660299", "管理费用/其他费用",   "损益", "借"),
        "软饮料":       ("660299", "管理费用/其他费用",       "损益", "借"),
        "洗涤剂":       ("660201", "管理费用/办公费",         "损益", "借"),
        "果类加工品":   ("660299", "管理费用/其他费用",       "损益", "借"),
        "焙烤食品":     ("660299", "管理费用/其他费用",       "损益", "借"),
        "水产加工品":   ("660299", "管理费用/其他费用",       "损益", "借"),
        "农副产品":     ("660299", "管理费用/其他费用",       "损益", "借"),
    }
